...
'  One thing I would DEFINITELY do differently is modularize this huge form.
'  As evidence of my poor coding style, I ended up putting 95% of the functionality
'  of the entire program inside the code for the "Main" form. I should have made
'  more modules instead.
